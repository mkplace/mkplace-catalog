catalog.config = {
    ...
    actions : {
        loading : function(show){
            if(show){
                $('body').prepend("<div id=main-loader style='background: rgba(0,0,0,0.3) center center no-repeat; z-index: 19999; width:100%; height:200%; position:absolute;'><h3 style='margin-top:300px;' class='text-muted text-center'>Carregando...</h3></div>");
            }else{
                $('#main-loader').hide();
            }
        }
